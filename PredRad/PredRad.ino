...
{
  char X[5], Y[5], Z[5]; 
  int x=((accel.readAX()/9.816)+36)*100, y=((accel.readAY()/9.816)+36)*100, z=((accel.readAZ()/9.816)+36)*100*20;
  int j=0;
...
{
  char B[6], T[5];
  unsigned int b=(barometer.readPressureMillibars()-150)*100, t=(barometer.readTemperatureC()+30)*100;
  int y=0;
