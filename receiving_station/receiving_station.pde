...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //РЕЖИМЫ ДО ОБРАБОТКИ ДАННЫХ И ПОСЛЕ
void Start()
{
    //режим окна до записи данных
    background(0);
    fill(255);
    textSize(100);
    text("Обработка данных в режиме", 230, 300);
    text("реального времени" , 450, 400);
    textSize(60);
    text("Для запуска программы нажмите CTRL", 320, 610);
    text("Для завершения программы нажмите ALT", 280, 690);
}
